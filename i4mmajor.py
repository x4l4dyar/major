...
\033[1;91m
   ...
   .|. | .||. .|.  .||. || .|'   ''|...|'  .||.  '|'
                      '''
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ My Telgram    @i4m_Major              
\033[1;98m    ║✯ My Chanal   @MajorCrackerChanal       
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m************************************************
\033[1;96m~ ☆ This Tool Careta By Major ☆ ~
\033[1;97m************************************************
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mMajorCracker\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mMajorCracker\033[1;95m•◈•══════••◈•"
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;91mName\033[1;95m:\033[1;95m "+op["name"]
		except KeyError:
			print"\x1b[1;91mID Nadozrayawa!"
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mMajorCracker\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---This Tool Maked by Major--•◈•---»" #i4m_Major
	print '\033[1;93m✅Bo Garanawa Ama bka ➡ Ctrl+Z.↩ bo Dast pe krdnawa am leda (python2 i4mmajor.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....MajorCracker....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Major"""
